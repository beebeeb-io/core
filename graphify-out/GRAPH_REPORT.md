...
## Corpus Check
- 109 files · ~184,681 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2431 nodes · 5463 edges · 34 communities detected
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 775 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (190): computeRecoveryCheck(), ConstellationDecoderHandle, constellationEncode(), constellationNewSession(), constellationVerifyCode(), createReader(), createWriter(), Data (+182 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (235): Opaque, hex(), main(), ok, config_new_sets_defaults(), config_roundtrips_through_json(), SyncConfig, SyncMode (+227 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (142): UniffiLib, computeRecoveryCheck(), ConstellationDecoderHandle, constellationEncode(), constellationNewSession(), constellationVerifyCode(), createReader(), createWriter() (+134 more)
...
Cohesion: 0.03
Nodes (96): AnyObject, ArchiveEntryDto, CachedFileEntryData, ChunkPlanResult, ConstellationDecoderHandleProtocol, ConstellationEdgeDto, ConstellationFrameDto, ConstellationNodeDto (+88 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (48): Data, FfiConverterData, FfiConverterOptionCallbackInterfaceDownloadProgressCallback, FfiConverterOptionCallbackInterfaceFileProgressCallback, FfiConverterOptionCallbackInterfaceUploadProgressCallback, FfiConverterOptionString, FfiConverterOptionTypeCachedFileEntryData, FfiConverterOptionTypeConstellationPayloadDto (+40 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (78): create(), Encryption, FfiConverterTypeCryptoError, boundaries_minimum_valid_single_chunk(), boundaries_single_chunk(), boundaries_three_chunks_with_remainder(), boundaries_two_equal_chunks(), compute_chunk_boundaries() (+70 more)
...
Cohesion: 0.09
Nodes (38): InvalidInput, ArchiveEntry, build_tar(), decompress_gzip(), gzip_invalid_data(), gzip_roundtrip(), list_archive(), list_archive_plain_gz() (+30 more)
...
- **Why does `ok` connect `Community 1` to `Community 0`, `Community 6`, `Community 8`, `Community 9`, `Community 11`, `Community 12`, `Community 14`, `Community 27`?**
  _High betweenness centrality (0.185) - this node is a cross-community bridge._
- **Why does `InitializationResult` connect `Community 0` to `Community 1`?**
  _High betweenness centrality (0.138) - this node is a cross-community bridge._
- **Why does `UniffiLib` connect `Community 2` to `Community 3`?**
  _High betweenness centrality (0.128) - this node is a cross-community bridge._
- **Are the 103 inferred relationships involving `ok` (e.g. with `derive_master_key()` and `derive_file_key()`) actually correct?**
  _`ok` has 103 INFERRED edges - model-reasoned connections that need verification._
