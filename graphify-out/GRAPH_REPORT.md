...
## Corpus Check
- 109 files · ~183,116 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2420 nodes · 5417 edges · 34 communities detected
...
3. `rustCallWithError()` - 56 edges
4. `rustCallWithError()` - 56 edges
5. `derive_master_key()` - 48 edges
...
Cohesion: 0.01
Nodes (187): computeRecoveryCheck(), ConstellationDecoderHandle, constellationEncode(), constellationNewSession(), constellationVerifyCode(), createReader(), createWriter(), Data (+179 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (143): UniffiLib, computeRecoveryCheck(), ConstellationDecoderHandle, constellationEncode(), constellationNewSession(), constellationVerifyCode(), createReader(), createWriter() (+135 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (193): hex(), main(), ok, config_roundtrips_through_json(), decrypt_downloaded_bytes(), decrypt_downloaded_empty_plaintext(), decrypt_downloaded_multi_chunk(), decrypt_downloaded_single_chunk() (+185 more)
...
Cohesion: 0.03
Nodes (94): AnyObject, CachedFileEntryData, ChunkPlanResult, ConstellationDecoderHandleProtocol, ConstellationEdgeDto, ConstellationFrameDto, ConstellationNodeDto, ConstellationPayloadDto (+86 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (49): ArchiveEntryDto, Data, FfiConverterData, FfiConverterOptionCallbackInterfaceDownloadProgressCallback, FfiConverterOptionCallbackInterfaceFileProgressCallback, FfiConverterOptionCallbackInterfaceUploadProgressCallback, FfiConverterOptionString, FfiConverterOptionTypeCachedFileEntryData (+41 more)
...
Cohesion: 0.12
Nodes (36): create(), Io, decrypt_chunks_to_file(), DecryptedFileResult, encrypt_decrypt_empty_file(), encrypt_decrypt_roundtrip(), encrypt_decrypt_smaller_than_chunk(), encrypt_decrypt_with_desktop_profile() (+28 more)
...
Cohesion: 0.11
Nodes (21): Conflict, conflict_without_prior_sync_when_timestamps_differ(), ConflictResolution, detect_conflicts(), detects_conflict_when_both_sides_changed(), FileMeta, loser_filename(), loser_filename_includes_device_and_time() (+13 more)
...
Cohesion: 0.11
Nodes (21): plan_chunks(), plan_chunks_large_file(), plan_chunks_small_file(), plan_chunks_unknown_profile_errors(), envelope_round_trip(), OpaqueEnvelope, backup_profile_keeps_100_gib_boundary_on_64_mib_chunks(), backup_profile_keeps_10_gib_boundary_on_16_mib_chunks() (+13 more)
...
- **Thin community `Community 20`** (23 nodes): `quota.rs`, `can_add_storage_per_plan()`, `can_add_users_per_plan()`, `effective_quota()`, `effective_quota_capped_at_99_tb()`, `effective_quota_extra_tb_on_pro()`, `effective_quota_ignores_extra_tb_for_free_and_basic()`, `effective_quota_with_bonus_bytes()`, `effective_quota_zero_extra()`, `format_storage_si_various()`, `max_extra_tb_per_plan()`, `max_extra_users_per_plan()`, `monthly_cost_cents_all_plans()`, `monthly_cost_cents_with_addons()`, `Plan`, `.base_storage_bytes()`, `.can_add_storage()`, `.can_add_users()`, `plan_from_slug_all_variants()`, `.max_extra_tb()`, `.max_extra_users()`, `.slug()`, `plan_slug_roundtrip()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 56`** (5 nodes): `error.rs`, `UploadError`, `.fmt()`, `.is_retryable()`, `.retry_after()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 73`** (3 nodes): `file.rs`, `ChunkMeta`, `EncryptedBlob`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 75`** (2 nodes): `error.rs`, `CoreError`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 76`** (2 nodes): `events.rs`, `SyncEvent`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 77`** (2 nodes): `error.rs`, `SyncError`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `ok` connect `Community 2` to `Community 1`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 14`, `Community 16`, `Community 17`?**
  _High betweenness centrality (0.177) - this node is a cross-community bridge._
- **Why does `InitializationResult` connect `Community 1` to `Community 2`?**
  _High betweenness centrality (0.131) - this node is a cross-community bridge._
- **Why does `UniffiLib` connect `Community 1` to `Community 0`, `Community 3`?**
